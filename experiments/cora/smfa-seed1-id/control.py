...
def evaluate(c,task,kind):
    ...
    for ep in range(c['control_episodes']):
        ...
        degrader=SingleID(kind,seed+10000000); score=0.; steps=0; adapter_times=[]
        ...
        row=dict(task=task,condition=condition,kind=kind,seed=seed,corruption_seed=seed+10000000,return_=score,decisions=steps,
