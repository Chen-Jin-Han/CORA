...
BASE=Path('/data1/CST/CORA/promptir-nafnet-baselines')
...
def report():
 ...
 for model in MODELS:
  ...
  assert ck['step']==15000 and ck['name']==model and ck['config_hash']==fingerprint(c)
 ...
 save_json(BASE/'verification.json',dict(complete=True,models=MODELS,seed=6,checkpoints=2,train_steps_each=15000,image_pairs_each=130000,formal_control_episodes=1500,markov_frame_files=20,markov_frame_positions=50000,baseline_full_reused=True))
